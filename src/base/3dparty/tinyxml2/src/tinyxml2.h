...
#define TINYXML2_INCLUDED			//防止重复包含

#if defined(ANDROID_NDK) || defined(__BORLANDC__)   //根据平台环境导入不容的头文件
#   include <ctype.h>
#   include <limits.h>
#   include <stdio.h>
#   include <stdlib.h>
...
#if defined( _DEBUG ) || defined( DEBUG ) || defined (__DEBUG__)		//确定是否为调试状态
#   ifndef DEBUG
#       define DEBUG
#   endif
#endif
...
#if defined(DEBUG)													//不同编译器下采用不同的断言宏
#   if defined(_MSC_VER)
